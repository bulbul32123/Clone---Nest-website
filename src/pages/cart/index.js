                    ...
                    <div className='row'>
                        <div className='col-md-8'>
                            <div className='d-flex align-items-center w-100'>
                                ...
                                <span className='ml-auto clearCart d-flex align-items-center cursor '><DeleteOutlineOutlinedIcon /> Clear Cart</span>
                                                ...
                                                context.cartItems?.map((item, index) => {
                                                    ...
                                                    return (
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <QuantityBox item={item} cartItems={context.cartItems} index={index} />
                                                            </td>
